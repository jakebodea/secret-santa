  ...
  return (
    <section className="bg-background py-32">
      <div className="container">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-normal text-foreground tracking-tight mb-10 text-center">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          {timelineData.map((entry, index) => (
            <div key={index} className="relative mb-10 pl-8">
              ...
              <h4 className="text-2xl sm:text-3xl leading-none font-medium rounded-xl py-2 xl:mb-4 xl:px-3">
                {entry.title}
              </h4>
